        ...
        <Box bg="#061a2a" color="white" py="48px" px={{ base: 6, md: 16 }}>
            ...
            >
                ...
                <VStack align="flex-start" spacing={3}>
                    ...
                    <Link href="#" color="#dbe6f0">Главная</Link>
                    <Link href="#" color="#dbe6f0">Что такое падел</Link>
                    <Link href="#" color="#dbe6f0">Преимущества</Link>
                    <Link href="#" color="#dbe6f0">Цены</Link>
                    <Link href="#" color="#dbe6f0">Пробная тренировка</Link>
                    <Link href="#" color="#dbe6f0">FAQ</Link>
                    <Link href="#" color="#dbe6f0">Контакты</Link>
                </VStack>
