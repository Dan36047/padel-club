        ...
        <Container>
            <Box mb="85px">
                <VStack spacing={4} mb="70px" align="center">
                    <Heading as="h2" fontWeight="bold" color="gray.800" fontSize={{base: '3xl', md: '5xl', lg: '6xl'}}>
                        Преимущества клуба
                    </Heading>
                    <Text fontSize={{base: "md", md: "xl"}} fontWeight={600}  color="gray.600" textAlign="center" pt="30px">
